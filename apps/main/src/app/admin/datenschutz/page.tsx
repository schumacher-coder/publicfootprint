...
export default function AdminDatenschutz() {
  const [content, setContent] = useState<DatenschutzContent | null>(null)
  ...
  const loadContent = async () => {
    try {
      const response = await fetch('/api/admin/datenschutz')
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-3xl font-light">Datenschutzerklärung bearbeiten</h1>
          </div>
